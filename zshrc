...
# Add Homebrew to PATH early (needed for oh-my-zsh plugins like direnv)
...
# ZSH_THEME_RANDOM_CANDIDATES=( "powerlevel10k" "agnoster" )
...
plugins=(git docker direnv vscode zsh-autosuggestions)

if [ ! -f $HOME/.oh-my-zsh/custom/themes/powerlevel10k/powerlevel10k.zsh-theme ]
then
